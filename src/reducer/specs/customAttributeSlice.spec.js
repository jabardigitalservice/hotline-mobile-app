...
const customAttributes = [
  {
    id: 1,
    attribute_description: 'The date at which the account on cs.digitalservice.id was created',
        ...
        entities: {
          1: {
            ...
            attribute_description:
              'The date at which the account on cs.digitalservice.id was created',
            attribute_display_name: 'Account Signup On',
            attribute_display_type: 'date',
            attribute_key: 'signedUpAt',
          },
